    ...
    <aside class="w-64 bg-gray-800 text-white flex flex-col">
        ...
        <nav class="flex-grow">
            <ul class="space-y-2 p-4">
                ...
                <li>
                    <a href="manage_laporan.php" class="<?php echo ($activePage == 'laporan') ? $activeClass : $inactiveClass; ?> flex items-center px-4 py-3 rounded-md transition-colors duration-200">
